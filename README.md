...
### As of now it is only meant to dim/blackout 1 connected screen since I only have one OLED screen in my particular setup(OLED laptop with 2 IPS monitors connected).
